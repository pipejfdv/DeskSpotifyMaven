...
INSERT INTO Roles (idRole, nameRole) VALUES (UUID.fromString('11111111-1111-1111-1111-111111111111'), 'ADMIN_ROLE');
INSERT INTO Roles (idRole, nameRole) VALUES (UUID.fromString('22222222-2222-2222-2222-222222222222'), 'USER_ROLE');
INSERT INTO Roles (idRole, nameRole) VALUES (UUID.fromString('33333333-3333-3333-3333-333333333333'), 'SING_ROLE');